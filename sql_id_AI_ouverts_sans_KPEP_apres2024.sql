--===========================================
-- Sélection finale : Compte le nombre de contrats souscrits depuis 2024
-- pour lesquels l'assuré n'a pas de KPEP rapproché dans le RUP.
--===========================================
WITH ens_ctr AS (
    --===========================================
    -- CTE : ens_ctr
...
--===========================================
-- Sélection finale : Compte les contrats souscrits depuis 2024
-- pour lesquels l'assuré n'a pas de KPEP rapproché dans le RUP.
--===========================================
...
FROM (
    ...
    FROM
        ass
    INNER JOIN ens_ctr ON (ass.num_ctr_indiv = ens_ctr.num_ctr_indiv) -- Jointure avec les contrats souscrits depuis 2024
